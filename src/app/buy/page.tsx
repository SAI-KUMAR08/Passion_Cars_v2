    ...
    <>
      ...
      <section className="py-12">
        <div className="container-wide">
            ...
            <div className="flex items-center gap-3">
              ...
              {hasActiveFilters && (
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-lg border border-gray-200 px-4 py-2.5 text-sm font-medium text-gray-500 transition-colors hover:border-red-200 hover:bg-red-50 hover:text-red-600"
                >
                  <X className="h-4 w-4" />
                  Clear
                </button>
          ...
          {/* Filter Panel */}
          {showFilters && (
            <div className="mt-4 animate-slide-down rounded-xl border border-gray-100 bg-white p-6 shadow-sm">
          ...
          {!loading && filteredCars.length > 0 && (
            <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {filteredCars.map((car, index) => (
                <ScrollReveal key={car.id} delay={index * 0.05}>
