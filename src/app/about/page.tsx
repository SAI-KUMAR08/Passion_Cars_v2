        ...
        <div className="container-wide">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <h2 className="mt-4 text-3xl font-bold text-dark-900 md:text-4xl">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 rounded-xl bg-accent-500 px-6 py-4 text-white shadow-xl">
            ...
            {values.map((value) => {
              ...
              return (
                <div key={value.title} className="card text-center">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-xl bg-accent-50 text-accent-500">
                    <Icon className="h-8 w-8" />
                  </div>
                  <h3 className="mb-2 text-lg font-bold text-dark-900">{value.title}</h3>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {teamMembers.map((member) => (
              <div key={member.name} className="card text-center">
                ...
                <p className="text-sm font-medium text-accent-500">{member.role}</p>
                <p className="mt-3 text-sm leading-relaxed text-dark-400">{member.bio}</p>
              </div>
            ))}
          </div>
        </div>
