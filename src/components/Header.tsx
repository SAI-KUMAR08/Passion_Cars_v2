        ...
        <div className="flex h-20 items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="-mt-1 text-[10px] font-medium uppercase tracking-widest text-dark-400">
              ...
              <Link
                ...
                className={`rounded-lg px-4 py-2 text-sm font-medium transition-colors ${
                  pathname === link.href
                    ...
                    : "text-dark-500 hover:bg-gray-50 hover:text-dark-900"
                }`}
              >
                {link.label}
              </Link>
          ...
          <div className="hidden items-center gap-3 lg:flex">
            ...
            {!user ? (
              <Link
                href="/login"
                className="flex items-center gap-2 rounded-lg border border-gray-200 px-4 py-2 text-sm font-medium text-dark-700 transition-colors hover:border-accent-200 hover:bg-accent-50 hover:text-accent-600"
              >
          ...
          <button
            ...
            className="rounded-lg p-2 text-dark-500 hover:bg-gray-100 lg:hidden"
